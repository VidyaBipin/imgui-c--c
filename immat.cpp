...
namespace ImGui
{
ImMat ImMat::resize(const ImSize size, float sw, float sh)
{
    ImMat mat;
    int srcw = w;
    int srch = h;
    ...
    if (c == 1)
        ...
        resize_bilinear_c2((const unsigned char*)data, srcw, srch, (unsigned char*)mat.data, _w, _h);
    else if (c == 3)
        resize_bilinear_c3((const unsigned char*)data, srcw, srch, (unsigned char*)mat.data, _w, _h);
    else if (c == 4)
