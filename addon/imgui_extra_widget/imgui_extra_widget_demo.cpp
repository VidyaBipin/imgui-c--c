        ...
        for (int y = 0; y < sidey; y++) {
            for (int x = 0; x < sidex; x++) {
                ...
                switch (y * sidex + x) {
                    ...
                    case  26: ImGui::SpinnerAng("SpinnerAng90NoBg", 16, 6, ImColor(255, 255, 255), ImColor(255, 255, 255, 0), 8.5f * velocity, IM_PI / 2.f); ImGui::ShowTooltipOnHover("SpinnerAng90NoBg"); break;
                    ...
                    case 131: ImGui::SpinnerSolarScaleBalls("SpinnerSolarScaleBalls", 16, 1.3f, ImColor(255, 0, 0), ImColor(255, 255, 255), 1 * velocity, 36); ImGui::ShowTooltipOnHover("SpinnerSolarScaleBalls"); break;
